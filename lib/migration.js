...
export const updateMigrationState = async (currentState, previousState) => {
  ...
  //delete static path from save to file
  await delete currentState.path;
  await delete currentState.backupPath;
  
  fs.writeFileSync(path, JSON.stringify(currentState, null, 4));
};
