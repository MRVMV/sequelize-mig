...
import Sequelize, { DataTypes as _DataTypes, ARRAY } from 'sequelize';
import hash from 'object-hash';
import { each, extend, clone, isEqual } from 'lodash';
...
const writeMigration = (
  ...
  let _commandsUp =
    `var migrationCommands = (transaction) => {return [ \n${ 
    migration.commandsUp.join(', \n') 
    } \n];};\n`;
  let _commandsDown =
    `var rollbackCommands = (transaction) => {return [ \n${ 
